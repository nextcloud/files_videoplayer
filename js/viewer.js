var videoViewer = {
	UI : {
		playerTemplate : '<header><link href="'+OC.filePath('videojs-sublime', 'videojs', 'src')+'/video-js.css" rel="stylesheet"><script src="'+OC.filePath('videojs-sublime', 'videojs', 'src')+'/video.js"></script>' + '<script>' +
		'_V_.options.flash.swf = "'+OC.filePath('videojs-sublime', 'videojs', 'src')+'/video-js.swf"' +
		'</script>' + '</header><video id="my_video_1" class="video-js vjs-sublime-skin" controls preload="auto" width="100%" height="100%" poster="'+OC.filePath('videojs-sublime', '', 'img')+'/poster.png" data-setup="{}">' +
